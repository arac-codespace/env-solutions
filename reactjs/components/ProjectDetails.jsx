...
export default class ProjectDetails extends React.Component {
  ...
  render() {
    ...
    if (filterValue && filterValue !== "Featured") {
      ...
      projects = projects.filter(isIndustry);
    ...
    let classNameOdd = projects.length%2 == 0 ? " col-md-5": " col-md-10";
    

    return (
        <TransitionGroup className="row justify-content-around">
          {projects.map((item,index) => ( 
            <CSSTransition
              ...
              classNames="fade"
            >
    		    	<div className={"col-12" + (index==0 ? classNameOdd:classNameEven)} style={[styles.project]}>
